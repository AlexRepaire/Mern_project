...
const EditProfile = ({ profile: { profile, loading }, createProfile, getCurrentProfile }) => {
    ...
    const onSubmit = async (e) => {
        ...
        //     const dataAlert = dispatch(setAlert('Profil Modifier !', 'success'));
        //     setTimeout(() => {
